...
- use `Export PNG` or `Export PDF` above a plot to capture a high-resolution figure with interaction controls hidden
...
- Gate refinement controls and edit handles for rectangle, polygon, and range gates that append explicit update commands
